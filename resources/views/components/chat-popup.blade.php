                ...
                <div>
                    ...
                    <div class="flex items-end gap-2 mb-2"
                        ...
                        <div class="flex flex-col min-w-0"
                            ...
                            {{-- Bulle --}}
                            <div class="px-3 py-2 rounded-2xl shadow-sm text-sm leading-relaxed break-words w-fit"
...
document.addEventListener('alpine:init', () => {
    ...
    // ->values() côté PHP + spread ici garantissent un vrai Array JS (pas un objet {})
    ...
    Alpine.data('chatPopupComponent', () => ({
        ...
        openChat() {
            this.chatOpen = true;
            // Bloquer le scroll du body sur mobile quand le chat est ouvert

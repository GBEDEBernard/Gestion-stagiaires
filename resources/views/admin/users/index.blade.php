    ...
    <div class="overflow-x-auto shadow-lg rounded-lg">
        <table class="min-w-full bg-white divide-y divide-gray-200 rounded-lg">
            ...
            <tbody class="bg-white divide-y divide-gray-200">
                ...
                <tr class="hover:bg-gray-50 transition-colors duration-150">
                    ...
                    <td class="px-6 py-4 whitespace-nowrap text-center flex justify-center gap-2">
                        <a href="{{ route('admin.users.edit', $user) }}" 
                           class="bg-blue-600 text-white px-3 py-1 rounded shadow hover:bg-blue-700 transition">Modifier</a>
                ...
                @empty
                <tr>
                    <td colspan="6" class="text-center py-8 text-gray-400 italic">Aucun utilisateur trouvé</td>
                </tr>
                @endforelse
            </tbody>
        </table>

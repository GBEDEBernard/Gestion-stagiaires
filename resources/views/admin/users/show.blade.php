<x-app-layout>
    ...
    // Date de naissance : robuste (peut être string ou DateTime selon les données)
                    ...
                    <div class="bg-white dark:bg-gray-800 rounded-xl shadow-lg overflow-hidden">
                        ...
                        <div class="p-6">
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                <div><label class="block text-sm text-gray-500 dark:text-gray-400">Nom</label>
                                    <p class="text-gray-900 dark:text-white font-medium">{{ $personnel?->nom ?? '-' }}</p>
                                </div>
                                <div><label class="block text-sm text-gray-500 dark:text-gray-400">Prénom</label>
                                    <p class="text-gray-900 dark:text-white font-medium">{{ $personnel?->prenom ?? '-' }}</p>
                                </div>
                                <div><label class="block text-sm text-gray-500 dark:text-gray-400">Email</label>
                                    <p class="text-gray-900 dark:text-white font-medium">{{ $displayEmail }}</p>
                                </div>
                                <div><label class="block text-sm text-gray-500 dark:text-gray-400">Téléphone</label>
                                    <p class="text-gray-900 dark:text-white font-medium">{{ $personnel?->telephone ?? '-' }}</p>
                                </div>
                                <div><label class="block text-sm text-gray-500 dark:text-gray-400">Genre</label>
                                    <p class="text-gray-900 dark:text-white font-medium">{{ $personnel?->genre ?? '-' }}</p>
                                </div>
                                <div><label class="block text-sm text-gray-500 dark:text-gray-400">Date de naissance</label>
                                    <p class="text-gray-900 dark:text-white font-medium">{{ $dateNaissanceFormatted }}</p>
                                </div>
                                @if($personnel && $personnel->adresse)
                                <div class="md:col-span-2"><label class="block text-sm text-gray-500 dark:text-gray-400">Adresse</label>
                    ...
                    <div class="bg-white dark:bg-gray-800 rounded-xl shadow-lg overflow-hidden">
                        ...
                        <div class="p-6">
                            <div class="grid grid-cols-1 gap-4">
                                <div><label class="block text-sm text-gray-500 dark:text-gray-400">École</label>
                                    <p class="text-gray-900 dark:text-white font-medium">{{ $profil->ecole ?? '-' }}</p>
                                </div>
                                @if($profil->supervisor_id)
                                <div><label class="block text-sm text-gray-500 dark:text-gray-400">Superviseur attitré</label>
                                    <p class="text-gray-900 dark:text-white font-medium">{{ optional($profil->supervisor)->name ?? '-' }}</p>
                                </div>
                                @endif
                            </div>
                        </div>
                    ...
                    <div class="bg-white dark:bg-gray-800 rounded-xl shadow-lg overflow-hidden">
                        ...
                        <div class="p-6">
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                ...
                                <div><label class="block text-sm text-gray-500 dark:text-gray-400">Site</label>
                                    <p class="text-gray-900 dark:text-white font-medium">{{ optional($profil->site)->name ?? '-' }}</p>
                                </div>
                                @if($profil->supervisor_id)
                                <div><label class="block text-sm text-gray-500 dark:text-gray-400">Superviseur attitré</label>
                                    <p class="text-gray-900 dark:text-white font-medium">{{ optional($profil->supervisor)->name ?? '-' }}</p>
                ...
                <div class="space-y-6">
                    <div class="bg-white dark:bg-gray-800 rounded-xl shadow-lg overflow-hidden">
                        ...
                        <div class="p-6 space-y-4">
                            ...
                            <div class="flex justify-between"><span class="text-gray-600 dark:text-gray-400">Dernière connexion</span><span class="font-medium text-gray-800 dark:text-white">{{ $user->updated_at->format('d/m/Y') }}</span></div>
                            ...
                            <div class="flex justify-between"><span class="text-gray-600 dark:text-gray-400">Rôle(s)</span>
                                <div class="flex flex-wrap gap-1">@foreach($user->getRoleNames() as $role)<span class="bg-purple-100 dark:bg-purple-900/30 text-purple-700 dark:text-purple-300 text-xs px-2 py-1 rounded">{{ $role }}</span>@endforeach</div>
                            </div>
                        </div>
                    </div>

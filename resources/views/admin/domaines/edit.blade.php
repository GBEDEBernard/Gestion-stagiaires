<x-app-layout>
    <div class="max-w-2xl mx-auto">
            ...
            <div class="flex items-center gap-4 mb-2">
                ...
                <div>
                    ...
                    <p class="text-gray-500 dark:text-gray-400 text-sm mt-0.5">
                        Modifiez les informations et les sites associés au domaine
                        <span class="font-semibold text-gray-700 dark:text-gray-300">{{ $domaine->nom }}</span>.
                    </p>
                </div>
            </div>
        </div>
        ...
        <div class="grid grid-cols-2 sm:grid-cols-3 gap-3 mb-6">
            ...
            <div class="bg-white dark:bg-gray-800 rounded-xl border border-gray-100 dark:border-gray-700 px-4 py-3">
                <p class="text-xs text-gray-500 dark:text-gray-400">Sites actuels</p>
                <p class="text-xl font-bold text-gray-900 dark:text-white mt-0.5">
                    {{ $domaine->sites->count() }}
                </p>
            </div>
            <div class="bg-white dark:bg-gray-800 rounded-xl border border-gray-100 dark:border-gray-700 px-4 py-3">
                ...
                <p class="text-sm font-semibold text-gray-900 dark:text-white mt-0.5">
                    {{ $domaine->created_at->format('d/m/Y') }}
                </p>
            </div>
        </div>
        ...
        <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-sm border border-gray-100 dark:border-gray-700 overflow-hidden">
            <form action="{{ encrypted_route('domaines.update', $domaine) }}" method="POST"
                    ...
                    <div class="ml-8 space-y-4">
                        ...
                        <div>
                            ...
                            <textarea name="description" id="description" rows="3"
                                ...
                                placeholder="Décrivez brièvement ce domaine de travail...">{{ old('description', $domaine->description) }}</textarea>
                            @error('description')
                ...
                <div class="p-6 space-y-5">
                    <div>
                        ...
                        <p class="text-sm text-gray-500 dark:text-gray-400 mt-1 ml-8">
                            Modifiez le ou les sites où ce domaine existe.
                        </p>
                    </div>

                    <div class="ml-8">
                        @php $selectedSiteIds = old('site_ids', $domaine->sites->pluck('id')->toArray()); @endphp
                        ...
                        @else
                            ...
                            <div class="flex items-center justify-between mb-3 pb-3 border-b border-gray-100 dark:border-gray-700">
                                ...
                                <span id="sites_count" class="text-xs text-gray-400 dark:text-gray-500">
                                    {{ count($selectedSiteIds) }} / {{ $sites->count() }} sélectionné(s)
                                </span>
                            </div>
                            ...
                            <div class="space-y-2">
                                ...
                                @php $isSelected = in_array($site->id, $selectedSiteIds); @endphp
                ...
                {{-- Boutons --}}
                <div class="px-6 py-4 bg-gray-50 dark:bg-gray-900/50 flex items-center justify-between gap-3">
                    <a href="{{ route('domaines.index') }}"
    ...
    <script>
        ...
        function updateCardStyle(checkbox) {
            ...
            if (checkbox.checked) {
                ...
                card.classList.remove('border-gray-200', 'dark:border-gray-700', 'bg-gray-50');
            } else {

    ...
    <div class="max-w-lg mx-auto">
        ...
        <div class="mb-8">
            <div class="flex items-center gap-4 mb-2">
                ...
                <h1 class="text-3xl font-bold text-gray-900 dark:text-white">Nouveau Type de Stage</h1>
            </div>
            <p class="text-gray-500 dark:text-gray-400 ml-14">Ajoutez un nouveau type de stage</p>
        </div>

        <!-- Formulaire -->
        <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-sm border border-gray-100 dark:border-gray-700 overflow-hidden">
            <form action="{{ route('type_stages.store') }}" method="POST" class="p-6 space-y-6">
                @csrf

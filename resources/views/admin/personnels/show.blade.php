                ...
                <div class="space-y-6">
                    ...
                    <div class="bg-white dark:bg-gray-800 rounded-xl shadow-lg overflow-hidden">
                        ...
                        <div class="p-6 space-y-3">
                            <a href="{{ encrypted_route('personnels.edit', $personnel) }}" class="w-full inline-flex justify-center items-center gap-2 px-4 py-2 bg-yellow-100 dark:bg-yellow-900/30 text-yellow-700 dark:text-yellow-300 rounded-xl hover:bg-yellow-200 dark:hover:bg-yellow-800/50 transition text-sm font-medium">
                                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z"/></svg>
                                Modifier le personnel
                            </a>

                            <form action="{{ encrypted_route('personnels.destroy', $personnel) }}" method="POST" onsubmit="return confirm('Supprimer définitivement ce personnel ? Cette action est irréversible.')">
                                @csrf @method('DELETE')

    ...
    <div class="mb-8 ml-4">
        <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-6">
            <div>
                ...
                <p class="text-gray-500 dark:text-gray-400 mt-1">Mettez à jour les informations du personnel et son type associé.</p>
            </div>
            ...
            <form action="{{ route('personnels.update', $personnel) }}" method="POST" class="p-6 space-y-6">
                ...
                <div class="grid gap-6 md:grid-cols-2">
                    <div>
                        ...
                        <input type="text" name="prenom" value="{{ old('prenom', $personnel->prenom) }}" required class="mt-2 w-full px-4 py-3 bg-gray-50 dark:bg-gray-900 border border-gray-200 dark:border-gray-700 rounded-xl" />
                    </div>
                    <div>
                        <label class="block text-sm font-medium text-gray-700 dark:text-gray-200">Nom *</label>
                        <input type="text" name="nom" value="{{ old('nom', $personnel->nom) }}" required class="mt-2 w-full px-4 py-3 bg-gray-50 dark:bg-gray-900 border border-gray-200 dark:border-gray-700 rounded-xl" />
                    </div>
                    <div>
                        <label class="block text-sm font-medium text-gray-700 dark:text-gray-200">Email *</label>
                        <input type="email" name="email" value="{{ old('email', $personnel->email) }}" required class="mt-2 w-full px-4 py-3 bg-gray-50 dark:bg-gray-900 border border-gray-200 dark:border-gray-700 rounded-xl" />
                    </div>
                    <div>
                        <label class="block text-sm font-medium text-gray-700 dark:text-gray-200">Téléphone</label>
                        <input type="text" name="telephone" value="{{ old('telephone', $personnel->telephone) }}" class="mt-2 w-full px-4 py-3 bg-gray-50 dark:bg-gray-900 border border-gray-200 dark:border-gray-700 rounded-xl" />
                    </div>
                    <div>
                    ...
                    <div>
                        ...
                        <input type="date" name="date_naissance" value="{{ old('date_naissance', $personnel->date_naissance) }}" class="mt-2 w-full px-4 py-3 bg-gray-50 dark:bg-gray-900 border border-gray-200 dark:border-gray-700 rounded-xl" />
                    </div>
                    <div class="md:col-span-2">
                        <label class="block text-sm font-medium text-gray-700 dark:text-gray-200">Adresse</label>
                        <textarea name="adresse" rows="3" class="mt-2 w-full px-4 py-3 bg-gray-50 dark:bg-gray-900 border border-gray-200 dark:border-gray-700 rounded-xl">{{ old('adresse', $personnel->adresse) }}</textarea>
                    </div>
                </div>
                ...
                <div class="bg-gray-50 dark:bg-gray-900 p-5 rounded-3xl border border-gray-200 dark:border-gray-700">
                    ...
                    <p class="text-sm text-gray-500 dark:text-gray-400 mt-1">Ce personnel est enregistré comme <strong>{{ $type === 'employe' ? 'Employé' : 'Étudiant' }}</strong>.</p>
                </div>
                ...
                <div id="etudiant-fields" class="space-y-6 {{ $type !== 'etudiant' ? 'hidden' : '' }}">
                    ...
                    <div>
                        ...
                        <input type="text" name="ecole" value="{{ old('ecole', optional($personnel->personnable)->ecole) }}" class="mt-2 w-full px-4 py-3 bg-gray-50 dark:bg-gray-900 border border-gray-200 dark:border-gray-700 rounded-xl" />
                    </div>
                </div>
                ...
                <div id="employe-fields" class="space-y-6 {{ $type !== 'employe' ? 'hidden' : '' }}">
                    ...
                    <div class="grid gap-6 md:grid-cols-2">
                        <div>
                            ...
                            <select name="domaine_id" class="mt-2 w-full px-4 py-3 bg-gray-50 dark:bg-gray-900 border border-gray-200 dark:border-gray-700 rounded-xl">
                                <option value="">Sélectionner</option>
                        ...
                        <div>
                            ...
                            <select name="site_id" class="mt-2 w-full px-4 py-3 bg-gray-50 dark:bg-gray-900 border border-gray-200 dark:border-gray-700 rounded-xl">
                                <option value="">Sélectionner</option>
                        ...
                        <div>
                            ...
                            <input type="text" name="poste" value="{{ old('poste', optional($personnel->personnable)->poste) }}" class="mt-2 w-full px-4 py-3 bg-gray-50 dark:bg-gray-900 border border-gray-200 dark:border-gray-700 rounded-xl" />
                        </div>
                        <div>
                            <label class="block text-sm font-medium text-gray-700 dark:text-gray-200">Matricule *</label>
                            <input type="text" name="matricule" value="{{ old('matricule', optional($personnel->personnable)->matricule) }}" class="mt-2 w-full px-4 py-3 bg-gray-50 dark:bg-gray-900 border border-gray-200 dark:border-gray-700 rounded-xl" />
                        </div>
                    </div>
                </div>

                <div class="flex flex-col sm:flex-row items-center gap-3">
                    <button type="submit" class="inline-flex items-center justify-center px-6 py-3 bg-sky-600 text-white rounded-xl hover:bg-sky-700 transition">Mettre à jour</button>

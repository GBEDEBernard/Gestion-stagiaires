    ...
    <div class="max-w-lg mx-auto">
        ...
        <div class="mb-8">
            <div class="flex items-center gap-4 mb-2">
                ...
                <h1 class="text-3xl font-bold text-gray-900 dark:text-white">Modifier l'école</h1>
            </div>
            <p class="text-gray-500 dark:text-gray-400 ml-14">Renommez l'école de provenance</p>
        </div>

        <!-- Formulaire -->
        <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-sm border border-gray-100 dark:border-gray-700 overflow-hidden">
            <form action="{{ encrypted_route('ecoles.update', $ecole) }}" method="POST" class="p-6 space-y-6">
                @csrf
                @method('PUT')
                ...
                <div>
                    ...
                    <input type="text" name="nom" id="nom" value="{{ old('nom', $ecole->nom) }}" required

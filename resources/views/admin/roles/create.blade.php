<x-app-layout>
    ...
    let currentOpen = null; // groupe actuellement ouvert
    ...
    function openGroup(group) {
        ...
        // Après la transition, libérer la hauteur pour les accordéons dynamiques (search)
    ...
    function closeGroup(group) {
        ...
        const chev = document.getElementById('chevron-' + group);
        if (!body) return;
        // Figer la hauteur avant d'animer vers 0
    ...
    function toggleAccordion(group) {
        ...
        // Fermer l'accordéon actuellement ouvert (s'il est différent)
    ...
    // ── Ouverture/fermeture instantanée (pour la recherche) ──────────────────────
    ...
    function filterPermissions(q) {
        let visible = 0;
        // Lors d'une recherche on ignore le mode "un seul ouvert"

<x-app-layout>
    <div class="max-w-2xl mx-auto">
        ...
        <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
            <form action="{{ route('etudiants.store') }}" method="POST" class="p-6 space-y-5">
                @csrf

                <div class="rounded-xl bg-blue-50 border border-blue-200 px-4 py-3 text-sm text-blue-700">
                    ⚠️ Aucun compte utilisateur n’est créé à cette étape. Vous pourrez générer un compte plus tard via le bouton dédié.
                </div>

                <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                    <div>
                        <label for="nom" class="block text-sm font-medium text-gray-700 mb-2">Nom <span class="text-red-500">*</span></label>
                        <input type="text" name="nom" id="nom" value="{{ old('nom') }}" required class="w-full px-4 py-3 bg-gray-50 border border-gray-200 rounded-xl focus:ring-2 focus:ring-emerald-500">
                    ...
                    <div>
                        ...
                        <input type="text" name="prenom" id="prenom" value="{{ old('prenom') }}" required class="w-full px-4 py-3 bg-gray-50 border border-gray-200 rounded-xl focus:ring-2 focus:ring-emerald-500">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                    <div>
                        ...
                        <select name="genre" id="genre" class="w-full px-4 py-3 bg-gray-50 border border-gray-200 rounded-xl focus:ring-2 focus:ring-emerald-500">
                    ...
                    <div>
                        ...
                        <input type="email" name="email" id="email" value="{{ old('email') }}" required class="w-full px-4 py-3 bg-gray-50 border border-gray-200 rounded-xl">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                    <div>
                        ...
                        <input type="text" name="telephone" id="telephone" value="{{ old('telephone') }}" class="w-full px-4 py-3 bg-gray-50 border border-gray-200 rounded-xl">
                ...
                <div class="flex items-center justify-end gap-4 pt-4 border-t border-gray-100">
                    ...
                    <button type="submit" class="px-6 py-3 bg-gradient-to-r from-emerald-500 to-teal-600 text-white rounded-xl hover:from-emerald-600 hover:to-teal-700 transition flex items-center gap-2">

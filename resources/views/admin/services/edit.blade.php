    ...
    <div class="max-w-lg mx-auto">
        ...
        <div class="mb-8">
            <div class="flex items-center gap-4 mb-2">
                ...
                <h1 class="text-3xl font-bold text-gray-900 dark:text-white">Modifier le Service</h1>
            </div>
            <p class="text-gray-500 dark:text-gray-400 ml-14">Modifiez les informations du service</p>
        </div>

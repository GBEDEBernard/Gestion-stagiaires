<x-app-layout>
    ...
    document.addEventListener('DOMContentLoaded', function () {
        ...
        window.switchPeriod = function (period) {
            ...
            if (period === 'semaine') { buildInscriptions(LABELS_SEMAINE, DATA_SEMAINE); }
        ...
        (function () {
            ...
            new Chart(ctx, {
                ...
                data: {
                    labels: labels,
                    datasets: [
                        { label:'En cours',  data:enCours,  backgroundColor:'#22c55e', borderRadius:4, borderSkipped:false },
                        { label:'Terminés',  data:termines, backgroundColor:'#a855f7', borderRadius:4, borderSkipped:false },
                        { label:'À venir',   data:inscrits, backgroundColor:'#f97316', borderRadius:4, borderSkipped:false }
                    ]
                },
                options: {
                    responsive: true, maintainAspectRatio: false,

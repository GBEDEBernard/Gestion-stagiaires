<x-app-layout>
    ...
    document.addEventListener('DOMContentLoaded', function () {
        ...
        function tip() {
            return { backgroundColor: 'rgba(15,23,42,.88)', titleColor: '#f8fafc', bodyColor: '#cbd5e1', padding: 12, cornerRadius: 8 };
        }
        ...
        (function () {
            ...
            new Chart(ctx, {
                ...
                data: {
                    labels: SM_LABELS,
                    datasets: [{ label: 'Stages créés', data: SM_DATA, backgroundColor: 'rgba(139,92,246,0.75)', borderRadius: 6, borderSkipped: false }]
                },
                options: {
                    responsive: true, maintainAspectRatio: false,
                    plugins: { legend: { display: false }, tooltip: tip() },

...
<div x-data="{ sidebarOpen: false }" class="relative">
    ...
    <!-- OUVERTURE SIDEBAR MOBILE : Nouveau bouton "Menu" discret en haut à gauche (remplace ancien hamburger) -->
    <button @click="sidebarOpen = !sidebarOpen"
        class="sm:hidden fixed top-4 left-4 z-[60] p-3 rounded-2xl 
    ...
    active:scale-95 transition-all duration-300 font-semibold text-sm tracking-wide"
        ...
        <!-- Icône hamburger + texte "Menu" pour clarté -->
    ...
    <!-- Commentaire : Bouton ouverture discret gauche avec texte "Menu" français.
     Transforme en 1 seul bouton "Retour" à droite quand ouvert.
     UX pro : gauche=ouvrir, droite=fermer, overlay=tap outside. -->
    ...
    <button @click="sidebarOpen = !sidebarOpen"
        <!-- Bouton Hamburger supprimé : utilise maintenant uniquement "Retour" à droite pour fermer (plus propre) -->

        <!-- BOUTON "← RETOUR" PROPRE À DROITE DANS SIDEBAR - Uniquement mobile, remplace X + hamburger -->
        <button @click="sidebarOpen = false"
            class="sm:hidden absolute top-6 right-6 z-[55] flex items-center gap-2 px-4 py-2.5
    ...
    hover:scale-105 hover:border-emerald-400/60 active:scale-95 transition-all duration-300"
            ...
            <!-- Icône flèche gauche professionnelle -->
        ...
        <!-- Commentaire : Bouton unique et propre à droite, design pro avec gradient emerald au hover.
     Supprime duplication : plus de hamburger gauche ni X, seulement ce "Retour" + overlay cliquable.
     Français complet, accessible (aria-label), responsive (sm:hidden). -->
        ...
        <div x-show="sidebarOpen" @click="sidebarOpen = false"
            ...
            role="button" tabindex="0" aria-label="Fermer le menu en cliquant dehors">
        </div>

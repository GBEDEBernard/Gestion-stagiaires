                    ...
                    <div x-data="{ open: false }" class="space-y-1">
                        ...
                        <div x-show="open" x-cloak x-transition:enter="transition ease-out duration-300" x-transition:enter-start="opacity-0 -translate-y-2" x-transition:enter-end="opacity-100 translate-y-0" class="ml-4 space-y-1.5 pl-3 border-l-2 border-emerald-500/30 bg-slate-900/50 rounded-2xl p-3">
                            ...
                            <a href="{{ route('attendance.tracking.index') }}" class="group flex items-center gap-3 pl-3 pr-4 py-3 rounded-xl text-sm font-semibold text-slate-300 hover:bg-blue-600/20 hover:text-blue-200 hover:translate-x-1 transition-all duration-300">
                                <div class="w-7 h-7 flex items-center justify-center bg-blue-500/10 text-blue-400 rounded-lg group-hover:bg-blue-500/20 transition-colors"><svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2.5" d="M15 10l4.553-2.276L20 10V18H4V6L8.553 3.724 12 6 15.447 3.724 20 6" />
                            ...
                            <a href="{{ route('admin.presence.pointage-suivi') }}" class="group flex items-center gap-3 pl-3 pr-4 py-3 rounded-xl text-sm font-semibold text-slate-300 hover:bg-emerald-600/20 hover:text-emerald-200 hover:translate-x-1 transition-all duration-300">
                                <div class="w-7 h-7 flex items-center justify-center bg-emerald-500/10 text-emerald-400 rounded-lg group-hover:bg-emerald-500/20 transition-colors"><svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2.5" d="M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1v-5m10-10l2 2m-2-2v10a1 1 0 01-1 1v-5m-6 0a1 1 0 001-1v5" />
                                    </svg></div>
                            ...
                            <a href="{{ route('admin.reports.index') }}" class="group flex items-center gap-3 pl-3 pr-4 py-3 rounded-xl text-sm font-semibold text-slate-300 hover:bg-amber-600/20 hover:text-amber-200 hover:translate-x-1 transition-all duration-300">
                                <div class="w-7 h-7 flex items-center justify-center bg-amber-500/10 text-amber-400 rounded-lg group-hover:bg-amber-500/20 transition-colors"><svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2.5" d="M13 7h8m0 0v8m0-8l-9 9-4-4-6 6" />
                                    </svg></div>
                            ...
                            <a href="{{ route('admin.presence.anomalies') }}" class="group flex items-center gap-3 pl-3 pr-4 py-3 rounded-xl text-sm font-semibold text-slate-300 hover:bg-rose-600/20 hover:text-rose-200 hover:translate-x-1 transition-all duration-300">
                                <div class="w-7 h-7 flex items-center justify-center bg-rose-500/10 text-rose-400 rounded-lg group-hover:bg-rose-500/20 transition-colors"><svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <div x-data="{ open: false }" class="space-y-1">
                    ...
                    <div x-show="open" x-cloak x-transition:enter="transition ease-out duration-300" x-transition:enter-start="opacity-0 -translate-y-2" x-transition:enter-end="opacity-100 translate-y-0" class="ml-4 space-y-1.5 pl-3 border-l-2 border-emerald-500/30 bg-slate-900/50 rounded-2xl p-3">
                        ...
                        <a href="{{ route('presence.pointage') }}" class="flex items-center gap-3 pl-3 pr-4 py-3.5 rounded-xl text-sm font-semibold text-slate-300 hover:bg-emerald-600/20 hover:text-emerald-200 hover:translate-x-1 transition-all duration-300 border border-slate-700/20 bg-slate-800/20 shadow-sm hover:shadow-emerald-500/30">
                            <div class="p-2 rounded-xl bg-emerald-500/30 ring-1 ring-emerald-500/40"><svg class="w-4 h-4 text-emerald-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <a href="{{ route('reports.index') }}" class="flex items-center gap-3 pl-3 pr-4 py-3.5 rounded-xl text-sm font-semibold text-slate-300 hover:bg-amber-600/20 hover:text-amber-200 hover:translate-x-1 transition-all duration-300 border border-slate-700/20 bg-slate-800/20 shadow-sm hover:shadow-amber-500/30">
                            <div class="p-2 rounded-xl bg-amber-500/30 ring-1 ring-amber-500/40"><svg class="w-4 h-4 text-amber-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <a href="{{ route('presence.historique') }}" class="flex items-center gap-3 pl-3 pr-4 py-3.5 rounded-xl text-sm font-semibold text-slate-300 hover:bg-blue-600/20 hover:text-blue-200 hover:translate-x-1 transition-all duration-300 border border-slate-700/20 bg-slate-800/20 shadow-sm hover:shadow-blue-500/30">
                            <div class="p-2 rounded-xl bg-blue-500/30 ring-1 ring-blue-500/40"><svg class="w-4 h-4 text-blue-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <div class="mb-3" x-data="{ open: false }">
                    ...
                    <div x-show="open" x-collapse @click.outside="open = false" class="mt-3 ml-4 space-y-2 overflow-hidden">
                        ...
                        <a href="{{ route('admin.users.index') }}" class="flex items-center gap-3 px-4 py-3 rounded-xl text-sm text-slate-400 hover:text-white hover:bg-slate-800/60 transition-all duration-200 group hover:translate-x-1">
                            <div class="w-1.5 h-1.5 rounded-full bg-orange-500 group-hover:bg-orange-400 transition-colors"></div>
                            <svg class="w-4 h-4 text-slate-500 group-hover:text-orange-400 transition-colors" fill="currentColor" viewBox="0 0 16 16">
                                <path fill-rule="evenodd" d="M15.854 5.146a.5.5 0 0 1 0 .708l-3 3a.5.5 0 0 1-.708 0l-1.5-1.5a.5.5 0 0 1 .708-.708L12.5 7.793l2.646-2.647a.5.5 0 0 1 .708 0" />
                                <path d="M1 14s-1 0-1-1 1-4 6-4 6 3 6 4-1 1-1 1zm5-6a3 3 0 1 0 0-6 3 3 0 0 0 0 6" />
                            </svg>
                            <div class="flex flex-col"><span>Utilisateurs</span>
                        ...
                        <a href="{{ route('sites.index') }}" class="flex items-center gap-3 px-4 py-3 rounded-xl text-sm text-slate-400 hover:text-white hover:bg-slate-800/60 transition-all duration-200 group hover:translate-x-1">
                            <div class="w-1.5 h-1.5 rounded-full bg-cyan-500 group-hover:bg-cyan-400 transition-colors"></div>
                            <svg class="w-4 h-4 text-slate-500 group-hover:text-cyan-400 transition-colors" fill="currentColor" viewBox="0 0 16 16">
                            ...
                            <div class="flex flex-col"><span>Sites</span>
                                <p class="text-xs text-slate-500 group-hover:text-slate-400">Lieux & géofencing</p>
                            </div>
                        </a>
                        @endcan
                        @can('personnels.view')
                        <a href="{{ route('personnels.index') }}" class="flex items-center gap-3 px-4 py-3 rounded-xl text-sm text-slate-400 hover:text-white hover:bg-slate-800/60 transition-all duration-200 group hover:translate-x-1 {{ request()->routeIs('personnels.*') ? 'bg-indigo-600/20 text-indigo-200' : '' }}">
                            <div class="w-1.5 h-1.5 rounded-full bg-purple-500 group-hover:bg-purple-400 transition-colors"></div>
                            <svg class="w-4 h-4 text-slate-500 group-hover:text-purple-400 transition-colors" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            ...
                            <div class="flex flex-col"><span>Personnel</span>
                                <p class="text-xs text-slate-500 group-hover:text-slate-400">Liste et gestion</p>
                            </div>
                        </a>
                        @endcan
                        @can('domaines.view')
                        <a href="{{ route('domaines.index') }}" class="flex items-center gap-3 px-4 py-3 rounded-xl text-sm text-slate-400 hover:text-white hover:bg-slate-800/60 transition-all duration-200 group hover:translate-x-1 {{ request()->routeIs('domaines.*') ? 'bg-indigo-600/20 text-indigo-200' : '' }}">
                            ...
                            <svg class="w-4 h-4 text-slate-500 group-hover:text-indigo-400 transition-colors" fill="currentColor" viewBox="0 0 16 16">
                                <path d="M1 2.5A1.5 1.5 0 0 1 2.5 1h3A1.5 1.5 0 0 1 7 2.5v3A1.5 1.5 0 0 1 5.5 7h-3A1.5 1.5 0 0 1 1 5.5zm8 0A1.5 1.5 0 0 1 10.5 1h3A1.5 1.5 0 0 1 15 2.5v3A1.5 1.5 0 0 1 13.5 7h-3A1.5 1.5 0 0 1 9 5.5zm-8 8A1.5 1.5 0 0 1 2.5 9h3A1.5 1.5 0 0 1 7 10.5v3A1.5 1.5 0 0 1 5.5 15h-3A1.5 1.5 0 0 1 1 13.5zm8 0A1.5 1.5 0 0 1 10.5 9h3a1.5 1.5 0 0 1 1.5 1.5v3a1.5 1.5 0 0 1-1.5 1.5h-3A1.5 1.5 0 0 1 9 13.5z" />
                            </svg>
                            <div class="flex flex-col"><span>Domaines</span>
                        ...
                        <a href="{{ route('tasks.index') }}" class="flex items-center gap-3 px-4 py-3 rounded-xl text-sm text-slate-400 hover:text-white hover:bg-slate-800/60 transition-all duration-200 group hover:translate-x-1">
                            ...
                            <svg class="w-4 h-4 text-slate-500 group-hover:text-amber-400 transition-colors" fill="currentColor" viewBox="0 0 16 16">
                                <path d="m13.498.795.149-.149a1.207 1.207 0 1 1 1.707 1.708l-.149.148a1.5 1.5 0 0 1-.059 2.059L4.854 14.854a.5.5 0 0 1-.233.131l-4 1a.5.5 0 0 1-.606-.606l1-4a.5.5 0 0 1 .131-.232l9.642-9.642a.5.5 0 0 0-.642.056L6.854 4.854a.5.5 0 1 1-.708-.708L9.44.854A1.5 1.5 0 0 1 11.5.796a1.5 1.5 0 0 1 1.998-.001" />
                            </svg>
                            <div class="flex flex-col"><span>Tâches</span>
                ...
                <a href="{{ route('etudiants.index') }}" class="flex items-center justify-between px-4 py-3.5 mb-2 rounded-2xl text-sm font-semibold text-slate-300 hover:bg-emerald-800/60 hover:text-white transition-all duration-300 group relative overflow-hidden">
                    ...
                    <div class="flex items-center gap-3 relative z-10">
                        <div class="p-2 rounded-xl bg-emerald-500/20">
                            <svg class="w-5 h-5 text-emerald-400" fill="currentColor" viewBox="0 0 16 16">

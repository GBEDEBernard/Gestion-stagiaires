<nav x-data="{ open: false }" class="bg-white border-b border-gray-100">
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-24">
            <div class="flex">
            <!-- Logo + Titre empilés verticalement -->
            <div class="flex flex-col items-center justify-center space-y-1 sm:items-start sm:justify-start sm:me-6">
               ...
               <a href="{{ route('dashboard') }} ">
                <h1 class="text-sm sm:text-base md:text-xl font-semibold text-gray-800 text-center sm:text-left">

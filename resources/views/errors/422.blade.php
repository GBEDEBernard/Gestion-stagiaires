...
<head>
    ...
    <title>Erreur de validation — {{ config('app.name', 'TFG') }}</title>
    ...
    <div class="tfg-page">
        ...
        <div class="tfg-card" style="max-width: 440px;">
            <div class="tfg-card-header" style="background: linear-gradient(135deg, #92400e 0%, #b45309 100%);">
                ...
                <span class="tfg-card-eyebrow"><span class="tfg-live-dot" style="background: #fcd34d;"></span><span style="color: rgba(255,255,255,0.55);">Erreur de validation</span></span>
            ...
            <div class="tfg-card-body" style="text-align: center; padding: 32px 24px 36px;">
                ...
                <p style="margin: 0 0 28px; color: #64748b; font-size: 0.85rem; line-height: 1.65; max-width: 320px; margin-left: auto; margin-right: auto;">
                    Les informations soumises sont incorrectes ou incomplètes. Veuillez vérifier vos données et réessayer.
                </p>

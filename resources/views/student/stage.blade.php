        ...
        <div class="rounded-[2rem] bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 px-6 py-7 text-white shadow-xl">
            <div class="flex flex-col gap-6 lg:flex-row lg:items-end lg:justify-between">
                ...
                <div class="flex flex-wrap gap-3">
                    <a href="{{ route('presence.index') }}" class="inline-flex items-center rounded-2xl bg-white px-4 py-2.5 text-sm font-medium text-slate-900 shadow-sm hover:bg-slate-100">
                        Pointer ma presence
                    </a>
                ...
                <div class="space-y-4">
                    ...
                    <div class="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm">
                        ...
                        <div class="mt-5 grid gap-3">
                            <a href="{{ route('presence.index') }}" class="inline-flex items-center justify-center rounded-2xl bg-slate-900 px-4 py-3 text-sm font-medium text-white hover:bg-slate-800">
                                Aller au pointage
                            </a>

<x-guest-layout>
    ...
    <h2 class="text-2xl font-bold text-blue-800 text-center mb-2">Définir votre mot de passe</h2>

    <p class="text-sm text-gray-600 text-center mb-6">
        Bienvenue ! Veuillez définir votre mot de passe pour activer votre compte.
    </p>

    <form method="POST" action="{{ route('password.first.update') }}" class="space-y-4">
        @csrf

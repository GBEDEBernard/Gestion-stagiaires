<x-app-layout>
    <div class="max-w-6xl mx-auto px-4 py-8">
        <div class="flex flex-col gap-3 md:flex-row md:items-center md:justify-between mb-6">
            ...
            <a href="{{ route('presence.index') }}" class="inline-flex items-center justify-center rounded-xl border border-slate-300 px-4 py-2.5 text-sm font-medium text-slate-700 hover:bg-slate-50">
                Revenir au pointage
            </a>
        </div>

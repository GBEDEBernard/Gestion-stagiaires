...
class StageController extends Controller
{
    ...
    public function store(Request $request)
    {
        $request->validate([
            ...
            // Horaires : l'arrivée fixe le seuil de retard, la pause est
    ...
    public function update(Request $request, Stage $stage)
    {
        ...
        $stage->update(array_merge($request->only([
            ...
            'date_debut',
            'date_fin',
            // Horaires : sans ces clés, le formulaire validait les heures puis
            // les jetait, et le stage gardait son horaire d'origine.
            'expected_check_in_time',
            'expected_check_out_time',
        ]), [
            'duree_mois'    => $request->nombre_mois,
